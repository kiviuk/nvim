return {
  "robitx/gp.nvim",
  cmd = { "GpChatNew", "GpChatToggle", "GpChatFinder", "GpChatPaste", "GpRewrite", "GpChat", "GpTask", "GpCmd" },
  config = function()
    local conf = {
      ...
      agents = {
        ...
        -- NVIDIA Nemotron 3 Super 120B (chat) - FREE
        {
          provider = "openrouter",
          name = "ChatNvidiaSuper120B",
          chat = true,
          command = false,
          model = { model = "nvidia/nemotron-3-super-120b-a12b:free", temperature = 0.8, top_p = 1 },
          system_prompt = require("gp.defaults").chat_system_prompt,
        },
        -- NVIDIA Nemotron 3 Super 120B (code) - FREE
        {
          provider = "openrouter",
          name = "ChatNvidiaSuper120B",
          chat = false,
          command = true,
          model = { model = "nvidia/nemotron-3-super-120b-a12b:free", temperature = 0.7, top_p = 1 },
          system_prompt = require("gp.defaults").code_system_prompt,
        },
        -- Z-AI GLM-4.7 (chat)
        {
        ...
        -- Z-AI GLM-5 (chat)
        {
          ...
          chat = true,
          command = false,
          model = { model = "z-ai/glm-5", temperature = 0.8, top_p = 1 },
          system_prompt = require("gp.defaults").chat_system_prompt,
        },
        -- Z-AI GLM-5 (code)
        {
          ...
          chat = false,
          command = true,
          model = { model = "z-ai/glm-5", temperature = 0.7, top_p = 1 },
          system_prompt = require("gp.defaults").code_system_prompt,
        },
